...
#
# Filtre o meu iterável por tipo. Posso ter qualquer coisa dentro do meu iterável.
...
if __name__ == "__main__":
    ...
    filtered: list[set[str]] = filter_by_type(mixed, set)
    reversed_groups = reverse_in_groups(mixed, 2)
    # cyan_print(filtered)
